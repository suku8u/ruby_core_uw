...
class Contacts
  ...
  hash1 = {full_name: "Barack Obama", city: "Washington", state: "DC", email: "president@wh.gov"}
  hash2 = {full_name: "Jason Shaw", city: "Seattle", state: "WA", email: "shawjaso@uw.edu"}
